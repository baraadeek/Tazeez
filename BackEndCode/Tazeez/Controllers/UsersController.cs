...
namespace Tazeez.Controllers
{
    ...
    public class UsersController : ApiBaseController
    {
        ...
        public IActionResult GetChildren(int page = 1, int pageSize = 10, string searchText = "")
        {
            var result = _userManager.GetChildren(LoggedInUser, page, pageSize, searchText);
            return Ok(result);
        }
        ...
        [MapToApiVersion("1")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
        public IActionResult AddChildren(AddChildrenRequest addChildrenRequest)
        {
            var result = _userManager.AddChildren(LoggedInUser, addChildrenRequest);
            return Ok(result);
        }
