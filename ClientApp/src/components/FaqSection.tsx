    ...
    <>
      <div className="faq-area-two ptb-100">
        <div className="faq-shape">
          <img src="assets/images/faq-shape1.png" alt="Faq" />
          <img src="assets/images/faq-shape2.png" alt="Faq" />
        </div>
          ...
          <div className="row">
            <div className="col-lg-6">
              <div className="faq-img">
                <img src="assets/images/faq-main.jpg" alt="Faq" />
            ...
            <div className="col-lg-6">
              <Accordion allowZeroExpanded preExpanded={["a"]}>
                ...
                <AccordionItem uuid="c">
                  <AccordionItemHeading>
                    <AccordionItemButton>
                      <span>Who has had COVID-19 spread the illness to others?</span>
                    </AccordionItemButton>
                  </AccordionItemHeading>
                  <AccordionItemPanel>
                    <p>
                ...
                <AccordionItem uuid="d">
                  <AccordionItemHeading>
                    <AccordionItemButton>
                      <span>Will warm weather stop the outbreak of COVID-19?</span>
                    </AccordionItemButton>
                  </AccordionItemHeading>
                  <AccordionItemPanel>
                    <p>
